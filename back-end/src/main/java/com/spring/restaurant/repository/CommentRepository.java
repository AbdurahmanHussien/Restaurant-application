...
public interface CommentRepository extends JpaRepository<Comment, Long> {
    ...
    @Query("SELECT DISTINCT c FROM Comment c LEFT JOIN FETCH c.user WHERE c.contactInfo.id = :contactInfoId")
    List<Comment> findByContactInfoIdWithUser(Long contactInfoId);
